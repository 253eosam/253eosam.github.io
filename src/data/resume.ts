      ...
      "projects": [
        {
          ...
          "details": [
            ...
            { "text": "메일 기능은 레이아웃 기반 라우팅으로 구조를 고정해 URL만으로 원하는 화면에 바로 진입할 수 있게 설계했고, Froala editor를 커스터마이징해 서명·템플릿 기능을 추가했습니다. 이 구조를 바탕으로 알림 기능에서도 타겟 이메일 화면으로 바로 이동할 수 있는 흐름을 구현했습니다." },
            { "text": "AI 기반 기능을 custom hook으로 구현하고 3개 페이지에서 재사용 가능한 구조로 정리했습니다." },
