...
> 한줄 정의: 조회는 entities, 변경은 features, 조합은 widgets, 배치는 app, 공통 재료는 shared에 둔다.
...
```txt
app       = 라우팅, 페이지 조립, server prefetch
widgets   = 페이지를 구성하는 섹션
features  = 사용자 행동
entities  = 비즈니스 도메인
...
page.tsx
  ...
  2. prefetchQuery 실행
  3. dehydrate
  4. HydrationBoundary로 client widget 감싸기
